"""
VLN-Cache evaluation config with cache ENABLED.

Identical to habitat_dual_system_cfg.py except:
    eval_settings["vln_cache_enabled"] = True
    output_path points to a separate directory.
...
eval_cfg = EvalCfg(
    ...
    eval_settings={
        "output_path": "./logs/habitat/test_dual_system_vln_cache",
        "save_video": False,
        "epoch": 0,
        "max_steps_per_episode": 500,
        # vis_analyze_new logging
        "analysis_enable_step_log": True,
        "analysis_collect_s2_log": True,
        "analysis_alignment_enable": True,
        "analysis_dump_dir": "./vis_analyze_new/data/raw_vln_cache",
