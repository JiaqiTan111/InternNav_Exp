"""
1/8-scale VLN-Cache config — ~230 episodes (1839/8), GPU 1.
...
eval_cfg = EvalCfg(
    ...
    eval_settings={
        "output_path": "./logs/habitat/vln_cache_eighth",
        "save_video": False,
        "epoch": 0,
        ...
        "analysis_dump_dir": "./vis_analyze_new/data/raw_vln_cache_eighth",
