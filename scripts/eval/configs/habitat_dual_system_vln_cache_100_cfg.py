"""
100-episode VLN-Cache config for efficiency metrics, GPU 1.

Usage:
    CUDA_VISIBLE_DEVICES=1 python scripts/eval/eval.py \
        --config scripts/eval/configs/habitat_dual_system_vln_cache_100_cfg.py
"""
...
eval_cfg = EvalCfg(
    ...
    eval_settings={
        "output_path": "./logs/habitat/vln_cache_100",
        "save_video": False,
        "epoch": 0,
        ...
        "analysis_dump_dir": "./vis_analyze_new/data/raw_vln_cache_100",
